                        			...
                        			<div class="row">
                        				<div class="col-md-12">
                        					<?php
                        						...
                        						echo form_open('Panitia_C/buat_jadwal_daftar_ulang',$attributes);
                        					?>
                        							...
                        							<div class="input-group">
                        								<?php
	                        								$attributes = array(
                                                            	...
                                                            	'id' => 'tanggal_mulai_buat_daftar_ulang',
                                                            	'name' => 'tgl_mulai'
	                                                        );
	                        						...
	                        						<div class="input-group">
	                        							<?php
	                        								$attributes = array(
	                                                            'class' => 'form-control',
	                                                            'placeholder' => 'yyyy/mm/dd',
                                                            	'id' => 'tanggal_selesai_buat_daftar_ulang',
                                                            	'name' => 'tgl_selesai'
	                                                        );
                                            ...
                                            <?php
                                                ...
                                                echo anchor('Panitia_C/lihat_jadwal_daftar_ulang','Batal',$attributes);?>

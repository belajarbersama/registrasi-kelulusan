    ...
    if (empty($username) && empty($password)) {
        ...
        ?>
            ...
            <div class="content-page">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    <?php
                                        $attributes = array(
                                            'id' => 'buat_jadwal_buku_seragam',
                                            'enabled' => TRUE,
                                            'class' => 'btn btn-default waves-effect waves-light'
                                        );

                                        echo anchor('Kesiswaan_C/form_buat_jadwal_buku_seragam','Buat Jadwal',$attributes);
                                    ?>
                                    <table id="demo-foo-filtering"
                                    data-toggle="table"
                                    data-toolbar="#buat_jadwal_buku_seragam" class="table table-striped toggle-circle m-b-0" data-page-size="9">
                                        <thead>
                                            <tr>
                                                    ...
                                                    <a title="Informasikan" href="#" class="on-default edit-row"><i style="color: #ffbd4a;" class="fa fa-send-o"></i>
                                                     <span></span></a>
                                                        ...
                                                        <?php
                                                            ...
                                                            echo anchor('Kesiswaan_C/hapus_jadwal_buku_seragam/'.$value->id_jadwal,' <i style="color:#f05050" class="fa fa-trash-o"></i> <span></span> ', $attributes);
                                                        ?>
                                                    </td>
                                                </tr>
                                                    <?php
                ...
                <!-- ============================================================== -->
                <!-- Modal EDIT Jadwal Her-Registrasi-->
                <!-- ============================================================== -->
                    ...
                    <div class="modal-dialog"> 
                        <div class="modal-content">
                            <?php
                                ...
                                echo form_open('Kesiswaan_C/edit_jadwal_buku_seragam',$attributes);
                            ?>
                                                ...
                                                <div class="input-group">
                                                    <?php 
                                                        $attributes = array(
                                                            'class' => 'form-control',
                                                            'placeholder' => 'yyyy/mm/dd',
                                                            'id' => 'tanggal_mulai_edit_buku_seragam',
                                                            'name' => 'tanggal_mulai'
                                                        );
                                                ...
                                                <div class="input-group">
                                                    <?php 
                                                        $attributes = array(
                                                            'class' => 'form-control',
                                                            'placeholder' => 'yyyy/mm/dd',
                                                            'id' => 'tanggal_selesai_edit_buku_seragam',

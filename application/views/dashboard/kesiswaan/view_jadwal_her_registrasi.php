                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    <?php
                                        $attributes = array(
                                            'id' => 'buat_jadwal_her_registrasi',
                                            'enabled' => TRUE,
                                            'class' => 'btn btn-default waves-effect waves-light'
                                        );

                                        echo anchor('Kesiswaan_C/form_buat_jadwal_her_registrasi','Buat Jadwal',$attributes);
                                    ?>
                                    <table id="demo-foo-filtering"
                                    data-toggle="table"
                                    data-toolbar="#buat_jadwal_her_registrasi" class="table table-striped toggle-circle m-b-0" data-page-size="9">
                                        <thead>
                                            <tr>
                                                    ...
                                                    <a title="Informasikan" href="#" class="on-default edit-row"><i style="color: #ffbd4a;" class="fa fa-send-o"></i>
                                                     <span></span></a>
                                                        ...
                                                        <?php
                                                            ...
                                                            echo anchor('Kesiswaan_C/hapus_jadwal_her_registrasi/'.$value->id_jadwal,' <i style="color:#f05050" class="fa fa-trash-o"></i> <span></span> ', $attributes);
                                                        ?>
                                                    </td>
                                                </tr>
                                                    <?php
                    ...
                    <div class="modal-dialog"> 
                        <div class="modal-content">
                            <?php
                                ...
                                echo form_open('Kesiswaan_C/edit_jadwal_her_registrasi',$attributes);
                            ?>

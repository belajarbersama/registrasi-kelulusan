                        			...
                        			<div class="row">
                        				<div class="col-md-12">
                        					<?php
                        						...
                        						echo form_open('Kesiswaan_C/buat_jadwal_pengambilan_ijazah',$attributes);
                        					?>
                        							...
                        							<div class="input-group">
                        								<?php
	                        								$attributes = array(
                                                            	...
                                                            	'id' => 'tanggal_mulai_buat_pengambilan_ijazah',
                                                            	'name' => 'tgl_mulai'
	                                                        );
	                        						...
	                        						<div class="input-group">
	                        							<?php
	                        								$attributes = array(
	                                                            'class' => 'form-control',
	                                                            'placeholder' => 'yyyy/mm/dd',
                                                            	'id' => 'tanggal_selesai_buat_pengambilan_ijazah',
                                                            	'name' => 'tgl_selesai'
	                                                        );
                                            ...
                                            <?php
                                                ...
                                                echo anchor('Kesiswaan_C/lihat_jadwal_pengambilan_ijazah','Batal',$attributes);?>
